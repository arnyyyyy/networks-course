...
1. Выберите один UDP-пакет. По этому пакету определите, сколько полей содержит UDP-заголовок.
   - ![Alt Text](https://github.com/arnyyyyy/networks-course/blob/master/lab06/images/t1.png)
...
2. Определите длину (в байтах) для каждого поля UDP-заголовка, обращаясь к отображаемой
   ...
   - Каждое значение представлено в виде 4-значного шестнадцатеричного числа, следовательно, каждый заголовок занимает 2 байта.
3. Значение в поле Length (Длина) – это длина чего?
   -  Это длина всего пакета = длина заголовка UDP (2 * 4 = 8 байт) + полезные данные (payload)
4. Какое максимальное количество байт может быть включено в полезную нагрузку UDP-пакета?
   - Полезная нагрузка = макс длина - длина заголовка =  2^16 - 1 - 8 = 65527 байт
5. Чему равно максимально возможное значение номера порта отправителя?
   -  2^16 - 1 = 65535
6. Какой номер протокола для протокола UDP? Дайте ответ и для шестнадцатеричной и
   десятеричной системы. Чтобы ответить на этот вопрос, вам необходимо заглянуть в поле
   Протокол в IP-дейтаграмме, содержащей UDP-сегмент.
   - ![Alt Text](https://github.com/arnyyyyy/networks-course/blob/master/lab06/images/t2.png)
   - 0x11, 17
7. Проверьте UDP-пакет и ответный UDP-пакет, отправляемый вашим хостом. Определите
   отношение между номерами портов в двух пакетах.
   - ![Alt Text](https://github.com/arnyyyyy/networks-course/blob/master/lab06/images/Снимок%20экрана%202025-04-13%20в%2011.42.43.png)
   -  ![Alt Text](https://github.com/arnyyyyy/networks-course/blob/master/lab06/images/Снимок%20экрана%202025-04-13%20в%2011.43.00.png)
...
#### Демонстрация работы
- ![Alt Text](https://github.com/arnyyyyy/networks-course/blob/master/lab06/images/ftp_no_gui.png)
...
#### Демонстрация работы
<img src="https://github.com/arnyyyyy/networks-course/blob/master/lab06/images/screen_rec.gif" width="700" height="600" />
