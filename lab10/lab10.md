...
1. Выберите первое ICMP-сообщение эхо-запроса, отправленное вашим компьютером, и
   ...
   - 198.168.0.130
   - ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab10/images/task1.png)
2. Найдите заголовок IP-пакета. Какое значение указано здесь в поле протокола верхнего уровня?
   - ICMP(1)
   - ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab10/images/task2.png)
3. Сколько байт в IP-заголовке? Сколько байт приходится на полезную нагрузку IP-дейтаграммы?
   - 20
   - 56 - 20 = 36
   - ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab10/images/task3.png)
4. Отсортируйте отслеженные пакеты по их исходному IP-адресу; для этого щелкните по
   ...
   2. Какие поля не меняются? Какие поля должны оставаться неизменными? Какие
      ...
      - Source Address, Destination Address, Version, Header Length, Differentiated Services Field, Protocol, Total Length, Flags
...
5. Какое значение содержится в поле Identification (Идентификация), а какое – в поле TTL
   (выберите какой-либо один пакет ICMP)?
      - 0x9202, 15
     - ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab10/images/task5.png)
...
7. Найдите серии откликов ICMP, в которых содержатся сообщения об истечении
   ...
   - 0, 251
   - ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab10/images/task7.png)
8. **Фрагментация**. Остановите захват пакетов в Wireshark. Измените размер пакета
   ...
   1. Было ли это сообщение фрагментировано между двумя или более IP-дейтаграммами? 
      ...
      - ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab10/images/task81.png)
      - Да, три
...
#### Демонстрация работы
![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab10/images/coding.png)
