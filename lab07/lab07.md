...
1. Какой IP-адрес и номер порта TCP использует ваш компьютер (отправитель), передающий
   ...
   - IP: 192.168.0.130
   - Порт: 59978
   - ![alt text] (https://github.com/arnyyyyy/networks-course/blob/master/lab07/images/task11.png)
3. Каков IP-адрес у сервера gaia.cs.umass.edu? Каковы номера портов для отправки и приема
   TCP-сегментов этого соединения?
   - IP: 128.119.245.12
   - Порт для отправки: 80
   <!-- todo -->
5. Какой порядковый номер у SYN TCP-сегмента, который используется для установления
   TCP-соединения между компьютером клиента и сервером gaia.cs.umass.edu? Как
   определяется, что это именно SYN-сегмент?
   - relative - 0, raw - 1391158195
   - во флагах указан SYN, значит это SYN-сегмент
   - ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab07/images/SYN.png)
    <!-- todo -->
7. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - relative - 0, raw - 14300040705
   - relative - 1, raw - 1391158196
   - сервер gaia.cs.umass.edu прибавил к исходному номеру SYN-сегмена единицу
   - установлен acknowledgement flag 
   - ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab07/images/SYNACK.png)
8. Какой порядковый номер у TCP-сегмента, содержащего команду POST протокола HTTP?
   ...
   - 224
   - ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab07/images/task5.png)
9. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   -  ![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab07/images/six.png)
   -  relative/raw: (1, 3947358309), (635, 3947358943), (2083, 3947360391), (3531, 3947361839), (4979, 3947363287), (6427, 3947364735) 
   -  4.984623, 4.984830, 4.984831, 4.984832, 4.984834, 4.984835 
   -  5.101831, 5.101832, 5.101833, 5.101834, 5.101834, 5.101835 
   -  0.117208, 0.117002, 0.117002, 0.117002, 0.117000, 0.117000
10. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   времени) для этого TCP-соединения? Объясните, как вы получили это значение.
   - size(alice.txt)/(time_ack_last - time_ack_first)
   - 152 КБ / (5.462576 - 4.984623) = ~318 байт/с
...
#### Скрин
![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab07/images/stevens.png)
...
#### Демонстрация работы
![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab07/images/logs_server.png)
...
#### Демонстрация работы
![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab07/images/logs_ping.png)
...
#### Демонстрация работы
![alt text](https://github.com/arnyyyyy/networks-course/blob/master/lab07/images/logs_heartbeat.png)
...
#### Решение
- использование канала = $\dfrac{size(окна) \cdot size(пакета)}{RTT \cdot пропускная способность}$
- $\dfrac{n \cdot 12000_{бит}}{0.03 \cdot 10^9} > 0.98$
- n > 2450
- n хотя бы 2451
