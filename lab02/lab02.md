...
#### Решение
* Рассмотрим путь последнего (P-го) пакета: суммарное время его пути равно сумме времени ожидания отправки пакетов перед ним и его времени в пути.
* Перед ним P-1 пакет, следовательно время ожидания составит $(P - 1) \dfrac{L}{R}$
...
#### Решение
* P(одновременно 12 и более пользователей) = 1 - P(одновременно 1 пользователь) - P(одновременно 2 пользователя) - .. - P(одновременно 11 пользоватедей)
...
* Общая задержка = $\dfrac{L}{R}$ + $\dfrac{I \cdot L}{R (1 – I)}$ = $\dfrac{L}{R}$ $(1 + \dfrac{I}{I-1})$ = $\dfrac{L}{R (1 - I)}$
